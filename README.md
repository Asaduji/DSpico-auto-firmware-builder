...
This will generate a new firmware build whenever the firmware, the bootloader or wrfuxxed get updated. Due to GitHub Actions limitations, updates must be scheduled to run once a day and won't be automatically triggered as soon as a commit is pushed to those repos.
